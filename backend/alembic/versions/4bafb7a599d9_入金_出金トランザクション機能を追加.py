...
def upgrade() -> None:
    ...
    with op.batch_alter_table('transactions', schema=None) as batch_op:
        ...
        batch_op.alter_column('transaction_type',
                   ...
                   type_=sa.Enum('buy', 'sell', 'deposit', 'withdrawal', name='transaction_type', native_enum=False),
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('transactions', schema=None) as batch_op:
        batch_op.alter_column('transaction_type',
                   existing_type=sa.Enum('buy', 'sell', 'deposit', 'withdrawal', name='transaction_type', native_enum=False),
